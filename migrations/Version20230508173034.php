...
final class Version20230508173034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE racer (id VARCHAR(255) NOT NULL, race_id VARCHAR(255) NOT NULL, age_category_placement INT DEFAULT NULL, overall_placement INT DEFAULT NULL, full_name VARCHAR(255) NOT NULL, finish_time INTEGER NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', distance VARCHAR(255) NOT NULL, age_category VARCHAR(255) NOT NULL, INDEX IDX_2ABA2E5F6E59D40D (race_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
